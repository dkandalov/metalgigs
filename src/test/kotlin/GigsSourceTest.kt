...
class GigsSourceTest {
    ...
    fun `extracts gig events from news page`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://www.useyourlocal.com/imgs/pub_events/sr@1x/240726-012017_threebirds-upd.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://www.useyourlocal.com/imgs/pub_events/sr@1x/270126-043912_smelllike.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from New Cross Inn gigs page, following the months dropdown`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 8),
                imageUrl = PosterUrl("https://pit.live/uploads/user/2026/07/07/640x480/5d05ygXA94bMG95I.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://pit.live/uploads/user/2026/07/24/640x480/t8YfuAmMlTMW6ilv.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from The Fiddler's Elbow whos-playing page`() {
        ...
        expectThat(events.first().copy(description = "")).isEqualTo(
            Gig(
                ...
                imageUrl = PosterUrl("https://images.squarespace-cdn.com/content/v1/56eabd14b6aa60459af3a4f2/1786573507310-PG9FBW6TLI2B45R0QU3D/Unknown-2.png"),
                description = "",
            ),
        )
        expectThat(events.last().copy(description = "")).isEqualTo(
            Gig(
                ...
                imageUrl = PosterUrl("https://images.squarespace-cdn.com/content/v1/56eabd14b6aa60459af3a4f2/1785973667820-T4D2VFAJ8AY9UAJQ4GHP/69613b4679576_event.jpeg"),
                description = "",
            ),
        )
    ...
    fun `extracts gig events from Our Black Heart events page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 8),
                imageUrl = PosterUrl("https://images.squarespace-cdn.com/content/v1/5486e6cde4b0d80114155bf4/1782745761879-UVSUIG341XJIY3MEB9MI/LBPHOTO%2B-%2B%2BYou%2BWin%2BAgain%2BGravity%2B-%2BPromo%2B-%2B20.10.2024%2B6.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://images.squarespace-cdn.com/content/v1/5486e6cde4b0d80114155bf4/1781025655512-MHR6PMWPOOE3TJFOSWAB/Necropolis_2027_IG_Feed_Poster_2nd_announcement%2B%25281%2529.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from The Underworld search-events page`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 8),
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-04-15/644411f7-5f86-484c-b29b-b71dc309b89e.jpg?rect=734%2C0%2C2682%2C2682"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-02-10/cf613856-3e58-41a8-b0f0-af044c77c97b.jpg?rect=228%2C0%2C2045%2C2045"),
                description = "",
            ),
        ...
        expectThat(events.count { it.imageUrl.value.contains("w=") }).isEqualTo(0)
        expectThat(events.count { it.imageUrl.value.contains("imgix.net") }).isEqualTo(73)
    }
    ...
    fun `extracts gig events from The Dome whatson page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 8),
                imageUrl = PosterUrl("https://images.squarespace-cdn.com/content/v1/6708f569091ee6412723acb9/1777381588492-CAQQZA5RRSD026668882/Cathedral%2BColour.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://images.squarespace-cdn.com/content/v1/6708f569091ee6412723acb9/1771509016965-K3W9K2G4J853EZ97RETL/Draconian+done-56+%28low+res%29.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from Blondies Brewery Taproom's dice_fm venue page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-08-03/6088fc1d-076f-4946-b1d6-342519c36355.jpg?rect=0%2C49%2C2159%2C2159"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-07-13/d2e1f34c-9f57-4a47-811c-5e6d4efbc40a.jpg?rect=0%2C135%2C1080%2C1080"),
                description = "",
            ),
    ...
    fun `extracts gig events from Blondies Bar's dice_fm venue page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 12),
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2025-07-23/03c4258d-44cc-4c61-8612-5d5495f6684b.jpg?rect=0%2C0%2C4385%2C4385"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-04-27/4c005268-bc5b-43c7-a69f-8117623d0232.jpg?rect=0%2C0%2C2048%2C2048"),
                description = "",
            ),
            urlPrefix = "https://dice.fm/event/",
        )
    ...
    fun `extracts gig events from Helgi's dice_fm venue page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-08-09/bcabb7e3-0777-4c15-929c-9192d05503fb.jpg?rect=0%2C32%2C1187%2C1187"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-04-07/cdca232f-2df2-41a6-a2b1-cdaa5c827aa3.jpg?rect=0%2C135%2C1080%2C1080"),
                description = "",
            ),
            urlPrefix = "https://dice.fm/event/",
        )
    ...
    fun `extracts gig events from Barfly Camden's dice_fm venue page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-08-06/1c3136b1-128c-4ca2-ac03-809114ab7663.jpg?rect=0%2C0%2C1080%2C1080"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-06-16/6f0ca902-24a7-4421-a288-f70e55030959.jpg?rect=0%2C0%2C1400%2C1400"),
                description = "",
            ),
            urlPrefix = "https://dice.fm/event/",
        )
    ...
    fun `extracts gig events from Electric Ballroom whats-on page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://electricballroom.co.uk/wp-content/uploads/2026/07/LION-BABE-.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://electricballroom.co.uk/wp-content/uploads/2026/06/Indiepalooza-2027.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from Dingwalls whats-on page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dingwalls.com/wp-content/uploads/elementor/thumbs/PP-5-ropdtf0hg2d9yqdycam42ynoc5vdz4n4gsylj8c3l8.png"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dingwalls.com/wp-content/uploads/elementor/thumbs/PP-27-rr5voszodg8dz4qw6s0thhnj6cm8eai4qgy0bw9ru4.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from The Garage live page`() {
        assertScrapesGigs(
            ...
            size = 43,
            first = Gig(
                id = GigId(theGarage.id, "https://www.thegarage.london/gigs/the-flatliners-a-wilhelm-scream-the-garage-lonodn-tickets-2026/"),
                title = GigTitle("THE FLATLINERS + A WILHELM SCREAM"),
                date = LocalDate.of(2026, 8, 22),
                imageUrl = PosterUrl("https://www.thegarage.london/wp-content/uploads/2026/03/Flatliners_2026_Ig-819x1024.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://www.thegarage.london/wp-content/uploads/2026/07/XXXYears-Poster-4-insta-819x1024.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from The Grace whats-on page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 14),
                imageUrl = PosterUrl("https://www.thegrace.london/wp-content/uploads/2026/05/FLAMEBEARER_IGNITER_ALBUM_LAUNCH_POSTER_SQUARE_v3_MED_RES_RGB-1-1024x1024.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                date = LocalDate.of(2026, 10, 31),
                imageUrl = PosterUrl("https://www.thegrace.london/wp-content/uploads/2026/05/PRESS-PHOTO-DD-3-1-1024x683.jpg"),
                description = "",
            ),
    ...
    fun `takes a DHP gig's poster from its page when the listing card has none`() {
        ...
        expectThat(events.single().imageUrl).isEqualTo(PosterUrl("https://example.com/article-poster.jpg"))
    }
    ...
    fun `takes a sold-out DHP gig's url from its notification, since its heading isn't a link`() {
        ...
        expectThat(events).containsExactly(
            Gig(
                ...
                imageUrl = PosterUrl("https://example.com/poster.jpg"),
    ...
    fun `extracts gig events from the Roundhouse whats-on page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://assets.roundhouse.org.uk/app/uploads/2026/04/Kristen-Schaal-4.png"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://assets.roundhouse.org.uk/app/uploads/2026/06/Roger_Taylor_London_1260x1280.jpg"),
                description = "",
            ),
    ...
    fun `extracts Blackhorse Road gigs from the Dice partner API`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-06-18/c2d85f59-1c17-4a96-8291-77270ebeba4b.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-07-10/63524421-198d-4192-bbd4-44bd063bf8e5.jpg"),
                description = "",
            ),
            urlPrefix = "https://dice.fm/event/",
        )
    ...
    fun `extracts Haggerston gigs from the Dice partner API`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-07-23/7a6ab6c3-0bb0-468a-b158-60bdc49f59c7.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-07-15/bab2924f-aa0a-4549-81e9-818da1a845b1.jpg"),
                description = "",
            ),
            urlPrefix = "https://dice.fm/event/",
        )
    ...
    fun `extracts gig events from the O2 Forum Kentish Town events api, skipping ones with no ticket link`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dynamicmedia.livenationinternational.com/g/v/y/79807d88-4cc2-4da8-acda-d434e0df08b2.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dynamicmedia.livenationinternational.com/t/a/f/03bb4ec9-ed69-4d30-b4d4-1e516b000455.jpg"),
                description = "",
            ),
            urlPrefix = "https://www.ticketmaster.co.uk/event/",
        )

        expectThat(events.count { it.imageUrl.value == amgDefaultPoster }).isEqualTo(3)
    }
    ...
    fun `extracts gig events from the O2 Academy Brixton events api`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl(amgDefaultPoster),
                description = "",
            ),
            last = Gig(
                ...
                date = LocalDate.of(2026, 9, 26),
                imageUrl = PosterUrl("https://dynamicmedia.livenationinternational.com/i/l/u/977ca756-1a25-4148-b46a-e2667effd53f.jpg"),
                description = "",
            ),
        ...
        expectThat(events.count { it.imageUrl.value == amgDefaultPoster }).isEqualTo(1)
    ...
    fun `extracts gig events from both O2 Academy Islington rooms, which share one listing`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dynamicmedia.livenationinternational.com/v/v/w/023063cb-a764-4f67-9d96-075a1bd3d454.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dynamicmedia.livenationinternational.com/m/a/b/e51bb674-c586-4164-9477-c725574f74ca.jpg"),
                description = "",
            ),
            urlPrefix = "https://www.ticketmaster.co.uk/event/",
        )

        expectThat(events.count { it.imageUrl.value == amgDefaultPoster }).isEqualTo(4)
    }
    ...
    fun `extracts gig events from the O2 Shepherd's Bush Empire events api`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://dynamicmedia.livenationinternational.com/s/x/l/353f9994-6437-4ccd-b401-a48c39f23a4b.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dynamicmedia.livenationinternational.com/e/o/k/21247638-dba8-45ed-9a31-5943a3bf78a6.png"),
                description = "",
            ),
        ...
        expectThat(events.count { it.imageUrl.value == amgDefaultPoster }).isEqualTo(2)
    ...
    fun `extracts gig events from Union Chapel's what's on page`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 12),
                imageUrl = PosterUrl("https://s3.eu-west-2.amazonaws.com/cdn.unionchapel.org.uk/files/MAVIS%20S.png"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://s3.eu-west-2.amazonaws.com/cdn.unionchapel.org.uk/files/Fairport%20Convention%2060th%20logo.jpg"),
                description = "",
            ),
        ...
        expectThat(events.count { it.imageUrl.value.isBlank() }).isEqualTo(0)
    ...
    fun `extracts gig events from Scala's live music category page, following pagination`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 19),
                imageUrl = PosterUrl("https://scala.co.uk/s/wp-content/uploads/2026/03/Digable-Planets-2026_colour-c-Emilio-Herce-scaled-e1774636627462.jpeg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://scala.co.uk/s/wp-content/uploads/2026/05/Scala-poster-Prf2_page-0001-1-e1779370004481.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from 229's Dice partner-widget API`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                title = GigTitle("LUN8 "),
                date = LocalDate.of(2026, 8, 14),
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-06-23/baa8fed2-8ece-4006-83d7-f9610c6622f3.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://dice-media.imgix.net/attachments/2026-06-01/e83611c7-842b-4a07-ae83-b29386d816dc.jpg"),
                description = "",
            ),
            urlPrefix = "https://dice.fm/event/",
        )
    ...
    fun `extracts gig events from Alexandra Palace's what's on page`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://www.alexandrapalace.com/wp-content/uploads/2026/05/pl-udl-approved-media-assets-14-of-17-marked-2048x1536.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://www.alexandrapalace.com/wp-content/uploads/2026/07/Kaleidescope-11.07.26-www.harbinson.uk-7159-2048x1366.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from Paper Dress Vintage's by-night page`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 14),
                imageUrl = PosterUrl("http://paperdressvintage.co.uk/wp-content/uploads/2026/07/poster-aug-14th-pd1-scaled.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("http://paperdressvintage.co.uk/wp-content/uploads/2026/07/Sam-Scherdel.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from Islington Assembly Hall's events page, following pagination`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 21),
                imageUrl = PosterUrl("https://islingtonassemblyhall.co.uk/app/uploads/2026/03/16a4e407-24c9-482a-9f0b-8f8b7812520a.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://islingtonassemblyhall.co.uk/app/uploads/2025/11/Untitled-design-1.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from Windmill Brixton's listings page, following pagination`() {
        val events = assertScrapesGigs(
            ...
            last = Gig(
                ...
                imageUrl = PosterUrl("https://musicglue-images-prod.global.ssl.fastly.net/windmill-brixton/event/2026-11-19-grommet-the-windmill?u=aHR0cHM6Ly9tdXNpY2dsdWUtdXNlci1hcHAtcC00LXAuczMuYW1hem9uYXdzLmNvbS9vcmlnaW5hbHMvYmJmYjAwYzItMDk2Ny00NmM4LWJiZjYtNmEyZDBhZDU3MTY4&v=2"),
                description = "",
            ),
    ...
    fun `extracts gig events from Eventim Apollo's events page`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 16),
                imageUrl = PosterUrl("https://aeg-media-assets.b-cdn.net/eventim/images/0e5e0082-1ed9-4180-97a0-5cb66a922ce7.jpg?width=768&height=768&focus_crop=1200,1200,0.5,0.5"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://aeg-media-assets.b-cdn.net/eventim/images/IL-VOLO-1080x1080-copy-1.jpg?width=768&height=768&focus_crop=1080,1080,0.5,0.5"),
                description = "",
            ),
    ...
    fun `extracts music events from OVO Arena's month calendar, leaving its other categories out`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 15),
                imageUrl = PosterUrl("https://www.ovoarena.co.uk/assets/img/STONEBWOY-BHIM-FEST-LONDON-1440x810-c5b626371c.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://www.ovoarena.co.uk/assets/img/Tash_2027_-1440x810-1ccd5e6573.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from indigo at The O2, paging past the listing's first batch`() {
        val events = assertScrapesGigs(
            ...
            size = 53,
            first = Gig(
                id = GigId(indigoAtTheO2.id, "https://www.theo2.co.uk/events/detail/timaya"),
                title = GigTitle("TIMAYA"),
                date = LocalDate.of(2026, 8, 22),
                imageUrl = PosterUrl("https://www.theo2.co.uk/assets/img/1080X1080-a8eecfe5d3.png"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://www.theo2.co.uk/assets/img/Steve-Steinmans-Fuel-Injected-Magic-50th-square-Post3er-jpg-48832cc6ba.jpg"),
                description = "",
            ),
    ...
    fun `extracts gig events from The O2 Arena, paging past the listing's first batch`() {
        val events = assertScrapesGigs(
            ...
            first = Gig(
                ...
                date = LocalDate.of(2026, 8, 19),
                imageUrl = PosterUrl("https://www.theo2.co.uk/assets/img/Static_TM-ArtistImage_2426x1365_ArianaGrande_2026_Photo-copy-square-b4f4051fe8.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://www.theo2.co.uk/assets/img/DD_1080-x-1080-Press-shot-32a180fd24.jpg"),
                description = "",
            ),
            urlPrefix = "https://www.theo2.co.uk/events/detail/",
        )
    ...
    fun `takes a posterless AMG gig's image from the page the event renders`() {
        ...
        expectThat(gig.imageUrl).isEqualTo(PosterUrl(amgDefaultPoster))
    }
    ...
    fun `does not fetch an event page for an AMG gig whose listing carries an image`() {
        ...
        expectThat(O2ForumKentishTownGigsSource(client).latestGigs().single().imageUrl)
    ...
    fun `extracts gig events from Electric Brixton's events page, following pagination`() {
        assertScrapesGigs(
            ...
            first = Gig(
                ...
                imageUrl = PosterUrl("https://e2h4j4t3.rocketcdn.me/wp-content/uploads/2025/01/Busspepper-1200.jpg"),
                description = "",
            ),
            last = Gig(
                ...
                imageUrl = PosterUrl("https://e2h4j4t3.rocketcdn.me/wp-content/uploads/2026/06/Elder-1200.jpg"),
                description = "",
            ),
