...
class GigsSourceTest {
    ...
    fun `extracts gig events from news page`() {
        val events = assertScrapesGigs(
            ...
            size = 21,
            first = Gig(
                id = GigId(Venue("Cart & Horses"), "https://www.cartandhorses.london/news-offers-events/523846-three-birds-whisper-the-positive-rebellion-tour-uk-2026-psychedelic-skies-borderline/"),
            ...
            last = Gig(
                id = GigId(Venue("Cart & Horses"), "https://www.cartandhorses.london/news-offers-events/517524-jbm-presents-smells-like-nirvana/"),
    ...
    fun `extracts gig events from New Cross Inn gigs page`() {
        assertScrapesGigs(
            ...
            size = 28,
            first = Gig(
                id = GigId(Venue("New Cross Inn"), "https://pit.live/events/greenhat"),
                title = "GREENHAT",
                date = LocalDate.of(2026, 8, 8),
                imageUrl = "https://pit.live/uploads/user/2026/07/07/640x480/5d05ygXA94bMG95I.jpg",
            ),
            last = Gig(
                id = GigId(Venue("New Cross Inn"), "https://pit.live/events/rudies-resurrection"),
    ...
    fun `extracts gig events from Our Black Heart events page`() {
        assertScrapesGigs(
            ...
            size = 50,
            first = Gig(
                id = GigId(Venue("Our Black Heart"), "https://www.ourblackheart.com/events/2026/8/8/you-win-again-gravity"),
            ...
            last = Gig(
                id = GigId(Venue("Our Black Heart"), "https://www.ourblackheart.com/events/2027/3/19/necropolis-vol-iii"),
    ...
    fun `extracts gig events from The Underworld search-events page`() {
        val events = assertScrapesGigs(
            ...
            size = 74,
            first = Gig(
                id = GigId(Venue("The Underworld"), "https://www.theunderworldcamden.co.uk/event/the-partisans-8th-aug-the-underworld-london-tickets/"),
                title = "THE PARTISANS",
                date = LocalDate.of(2026, 8, 8),
            ...
            last = Gig(
                id = GigId(Venue("The Underworld"), "https://www.theunderworldcamden.co.uk/event/alive-a-tribute-to-pearl-jam-20th-nov-the-underworld-london-tickets/"),
    ...
    fun `extracts gig events from The Dome whatson page`() {
        assertScrapesGigs(
            ...
            size = 70,
            first = Gig(
                id = GigId(Venue("The Dome"), "https://www.domelondon.co.uk/whatson/08/08-battlesnake"),
                title = "BATTLESNAKE",
                date = LocalDate.of(2026, 8, 8),
            ...
            last = Gig(
                id = GigId(Venue("The Dome"), "https://www.domelondon.co.uk/whatson/03/07-draconian"),
                title = "DRACONIAN",
    ...
    fun `extracts gig events from Blondies Brewery Taproom's dice_fm venue page`() {
        assertScrapesGigs(
            ...
            size = 9,
            first = Gig(
                id = GigId(Venue("Blondies Brewery Taproom"), "https://dice.fm/event/2wqb7p-its-never-over-jeff-buckley-screening-12th-aug-blondies-brewery-london-tickets"),
            ...
            last = Gig(
                id = GigId(Venue("Blondies Brewery Taproom"), "https://dice.fm/event/8eq9dw-forlorn-birdwitch-27th-nov-blondies-brewery-london-tickets"),
    ...
    fun `extracts gig events from Blondies Bar's dice_fm venue page`() {
        assertScrapesGigs(
            ...
            size = 26,
            first = Gig(
                id = GigId(Venue("Blondies Bar"), "https://dice.fm/event/av57g7-midweek-mayhem-4-pints-all-night-12th-aug-blondies-london-tickets"),
            ...
            last = Gig(
                id = GigId(Venue("Blondies Bar"), "https://dice.fm/event/bboxdm-1986-support-5th-dec-blondies-london-tickets"),
                title = "1986 + Support",
    ...
    fun `extracts gig events from Helgi's dice_fm venue page`() {
        assertScrapesGigs(
            ...
            size = 15,
            first = Gig(
                id = GigId(Venue("Helgi's"), "https://dice.fm/event/avrpa2-sceptocrypt-in-gods-way-cariad-14th-aug-helgis-london-tickets"),
            ...
            last = Gig(
                id = GigId(Venue("Helgi's"), "https://dice.fm/event/xedvra-holocaust-hyena-14th-nov-helgis-london-tickets"),
    ...
    fun `extracts gig events from Electric Ballroom whats-on page`() {
        assertScrapesGigs(
            ...
            size = 89,
            first = Gig(
                id = GigId(Venue("Electric Ballroom"), "https://electricballroom.co.uk/lion-babe/"),
            ...
            last = Gig(
                id = GigId(Venue("Electric Ballroom"), "https://electricballroom.co.uk/indiepalooza-tribute-killers-v-monkeys-v-fender-v-oasis-v-kasabian-v-kaiser/"),
    ...
    fun `extracts gig events from Dingwalls whats-on page`() {
        assertScrapesGigs(
            ...
            size = 24,
            first = Gig(
                id = GigId(Venue("Dingwalls"), "https://dingwalls.com/gig/root-company/"),
                title = "BANG YONGGUK",
            ...
            last = Gig(
                id = GigId(Venue("Dingwalls"), "https://dingwalls.com/gig/rock-for-hope-2/"),
                title = "Rock For Hope",
    ...
    fun `extracts gig events from The Garage live page`() {
        val events = assertScrapesGigs(
            ...
            size = 43,
            first = Gig(
                id = GigId(Venue("The Garage"), "https://www.thegarage.london/gigs/when-chai-met-toast/"),
                title = "WHEN CHAI MET TOAST",
                date = LocalDate.of(2026, 8, 14),
                imageUrl = "",
            ),
            last = Gig(
                id = GigId(Venue("The Garage"), "https://www.thegarage.london/gigs/black-altar-xxx-anniversary-show-the-garage-london-tickets-2026/"),
    ...
    fun `extracts gig events from The Grace whats-on page`() {
        assertScrapesGigs(
            ...
            size = 48,
            first = Gig(
                id = GigId(Venue("The Grace"), "https://www.thegrace.london/gigs/flamebearer-the-grace-london-tickets-2026/"),
                title = "FLAMEBEARER",
                date = LocalDate.of(2026, 8, 14),
            ...
            last = Gig(
                id = GigId(Venue("The Grace"), "https://www.thegrace.london/gigs/dreamdnvr-the-grace-london-tickets-2026/"),
                title = "DREAMDNVR",
                date = LocalDate.of(2026, 10, 31),
    ...
    fun `extracts gig events from the Roundhouse whats-on page`() {
        assertScrapesGigs(
            ...
            size = 9,
            first = Gig(
                id = GigId(Venue("Roundhouse"), "https://www.roundhouse.org.uk/whats-on/c59-theatre-week-15-17-sh26/"),
                title = "Centre 59 Theatre Week (15-17s)",
                date = LocalDate.of(2026, 8, 12),
                imageUrl = "https://assets.roundhouse.org.uk/app/uploads/2026/05/C59-15-17-1260x1280.jpg",
            ),
            last = Gig(
                id = GigId(Venue("Roundhouse"), "https://www.roundhouse.org.uk/whats-on/open-daw-ableton-18-25-sh26/"),
    ...
    fun `extracts only Blackhorse Road gigs from the shared Signature Brew events page`() {
        val events = assertScrapesGigs(
            ...
            last = Gig(
                id = GigId(Venue("Signature Brew Blackhorse Road"), "https://tixr.com/e/198560"),
    ...
    fun `extracts only Haggerston gigs from the shared Signature Brew events page`() {
        val events = assertScrapesGigs(
            ...
            size = 55,
            first = Gig(
                id = GigId(Venue("Signature Brew Haggerston"), "https://tixr.com/e/186035"),
            ...
            last = Gig(
                id = GigId(Venue("Signature Brew Haggerston"), "https://tixr.com/e/176800"),
    ...
    fun `extracts gig events from the O2 Forum Kentish Town events api, skipping ones with no ticket link`() {
        val events = assertScrapesGigs(
            ...
            size = 87,
            first = Gig(
                id = GigId(Venue("O2 Forum Kentish Town"), "https://www.ticketmaster.co.uk/event/3E00648FA8A634C8"),
            ...
            last = Gig(
                id = GigId(Venue("O2 Forum Kentish Town"), "https://www.ticketmaster.co.uk/event/3E0065059E6A1198"),
    ...
    fun `extracts gig events from the O2 Academy Brixton events api`() {
        val events = assertScrapesGigs(
            ...
            size = 67,
            first = Gig(
                id = GigId(Venue("O2 Academy Brixton"), "https://www.ticketmaster.co.uk/event/3E006464ACEB4803"),
                title = "Primus",
                date = LocalDate.of(2026, 8, 19),
                imageUrl = "",
            ),
            last = Gig(
                id = GigId(Venue("O2 Academy Brixton"), "https://www.ticketmaster.co.uk/event/3E006452FC929180"),
    ...
    fun `extracts gig events from both O2 Academy Islington rooms, which share one listing`() {
        val events = assertScrapesGigs(
            ...
            size = 83,
            first = Gig(
                id = GigId(Venue("O2 Academy Islington"), "https://www.ticketmaster.co.uk/event/3E00646A8FB52ACA"),
            ...
            last = Gig(
                id = GigId(Venue("O2 Academy Islington"), "https://www.ticketmaster.co.uk/event/3E0064F5350835B8"),
    ...
    fun `extracts gig events from the O2 Shepherd's Bush Empire events api`() {
        val events = assertScrapesGigs(
            ...
            size = 95,
            first = Gig(
                id = GigId(Venue("O2 Shepherd's Bush Empire"), "https://www.ticketmaster.co.uk/event/3E0064AFD611527C"),
                title = "AFI",
                date = LocalDate.of(2026, 8, 20),
                imageUrl = "https://dynamicmedia.livenationinternational.com/s/x/l/353f9994-6437-4ccd-b401-a48c39f23a4b.jpg",
            ),
            last = Gig(
                id = GigId(Venue("O2 Shepherd's Bush Empire"), "https://www.ticketmaster.co.uk/event/3E0064D0EB10676E"),
    ...
    fun `extracts gig events from Union Chapel's what's on page`() {
        val events = assertScrapesGigs(
            ...
            size = 119,
            first = Gig(
                id = GigId(Venue("Union Chapel"), "https://unionchapel.org.uk/whats-on/mavis-staples-12-aug-2026"),
                title = "MAVIS STAPLES: 12 AUG 2026",
                date = LocalDate.of(2026, 8, 12),
                imageUrl = "https://s3.eu-west-2.amazonaws.com/cdn.unionchapel.org.uk/files/MAVIS%20S.png",
            ),
            last = Gig(
                id = GigId(Venue("Union Chapel"), "https://unionchapel.org.uk/whats-on/fairport-convention-60th-anniversary"),
    ...
    fun `extracts gig events from Scala's live music category page, following pagination`() {
        val events = assertScrapesGigs(
            ...
            size = 55,
            first = Gig(
                id = GigId(Venue("Scala"), "https://scala.co.uk/events/digable-planets/"),
            ...
            last = Gig(
                id = GigId(Venue("Scala"), "https://scala.co.uk/events/split-the-dealer-deva-st-john/"),
    ...
    fun `extracts gig events from 229's Dice partner-widget API`() {
        assertScrapesGigs(
            ...
            size = 75,
            first = Gig(
                id = GigId(Venue("229"), "https://dice.fm/event/lun8-14th-aug-229-london-tickets"),
                title = "LUN8 ",
                date = LocalDate.of(2026, 8, 14),
                imageUrl = "https://dice-media.imgix.net/attachments/2026-06-23/baa8fed2-8ece-4006-83d7-f9610c6622f3.jpg",
            ),
            last = Gig(
                id = GigId(Venue("229"), "https://dice.fm/event/leo-kottke-9th-jun-229-london-tickets"),
                title = "Leo Kottke",
    ...
    fun `extracts gig events from Alexandra Palace's what's on page`() {
        val events = assertScrapesGigs(
            ...
            size = 41,
            first = Gig(
                id = GigId(Venue("Alexandra Palace"), "https://www.alexandrapalace.com/whats-on/upside-down-london/"),
            ...
            last = Gig(
                id = GigId(Venue("Alexandra Palace"), "https://www.alexandrapalace.com/whats-on/kaleidoscope-festival-2/"),
