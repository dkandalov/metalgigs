...
class GigsSourceTest {
    ...
    fun `extracts Blackhorse Road gigs from the Dice partner API`() {
        assertScrapesGigs(
            ...
            size = 23,
            first = Gig(
                GigId(signatureBrewBlackhorseRoad.id, "https://dice.fm/event/disco-2000-summer-yard-party-london-23rd-aug-signature-brew-blackhorse-road-london-tickets"),
            ...
            last = Gig(
                GigId(signatureBrewBlackhorseRoad.id, "https://dice.fm/event/dig-it-up-by-the-allergies-london-17th-apr-signature-brew-blackhorse-road-london-tickets"),
                GigTitle("Dig It Up by The Allergies | London"),
                LocalDate.of(2027, 4, 17),
    ...
    fun `extracts Haggerston gigs from the Dice partner API`() {
        assertScrapesGigs(
            ...
            size = 46,
            first = Gig(
                GigId(signatureBrewHaggerston.id, "https://dice.fm/event/papangu-zeta-meiotempo-london-18th-aug-signature-brew-haggerston-london-tickets"),
            ...
            last = Gig(
                GigId(signatureBrewHaggerston.id, "https://dice.fm/event/duck-dive-festival-2027-london-26th-feb-signature-brew-haggerston-london-tickets"),
    ...
    fun `extracts gig events from 229's Dice partner-widget API`() {
        assertScrapesGigs(
            ...
            last = Gig(
                GigId(twoTwoNine.id, "https://dice.fm/event/leo-kottke-9th-jun-229-london-tickets"),
                GigTitle("Leo Kottke"),
