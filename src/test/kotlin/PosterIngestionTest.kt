...
class PosterIngestionTest {
    ...
    fun `extracts one gig per line from the poster reply`() {
        ...
        expectThat(gigs).containsExactly(
            Gig(id = GigId(VenueId("some-venue"), "https://example.com/post/1#gig-doom-night-2026-08-14"), title = GigTitle("Doom Night"), date = LocalDate.of(2026, 8, 14), imageUrl = PosterUrl("https://example.com/poster.jpg"), description = "Doom Night"),
            Gig(id = GigId(VenueId("some-venue"), "https://example.com/post/1#gig-thrash-fest-2026-08-21"), title = GigTitle("Thrash Fest"), date = LocalDate.of(2026, 8, 21), imageUrl = PosterUrl("https://example.com/poster.jpg"), description = "Thrash Fest"),
        )
    }
