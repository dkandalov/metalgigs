---
name: daily-update
description: Run the full daily refresh (scrape, classify, render) and publish it - committing the changed files and pushing to GitHub. Use when asked to do the daily update, refresh and publish the gigs page, or update and push the site.
---
